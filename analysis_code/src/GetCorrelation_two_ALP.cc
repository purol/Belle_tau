...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    canvas_M_BDT_diff->SaveAs((argv[6] + std::string("/") + "BDT2_M_diff_distribution_" + std::string(argv[7]) + "_" + std::string(argv[8]) + "_" + std::string(argv[9]) + "_" + std::string(argv[10]) + ".png").c_str());
