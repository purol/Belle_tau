...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    loader.Cut(("(" + std::to_string(M_peak - 10 * M_left_sigma) + "< M_inv_tau) && (M_inv_tau < " + std::to_string(M_peak + 10 * M_right_sigma) + ")").c_str());
    loader.PrintInformation("========== -10 delta < M < 10 delta ==========");
