...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    loader.Cut(("(" + std::to_string(deltaE_peak - 20 * deltaE_left_sigma) + "< deltaE) && (deltaE < " + std::to_string(deltaE_peak + 20 * deltaE_right_sigma) + ")").c_str());
    loader.PrintInformation("========== -20 delta < deltaE < 20 delta ==========");
