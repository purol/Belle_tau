...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    if(argc == (7 + 2 * variable_num)) loader.ConditionalPairDrawStack(variable_pair, condition_order, (";" + variable_name + ";arbitrary unit").c_str(), (argv[5 + 2 * variable_num] + std::string("/") + argv[6 + 2 * variable_num] + ".png").c_str(), true);
    else if (argc == (9 + 2 * variable_num)) loader.ConditionalPairDrawStack(variable_pair, condition_order, (";" + variable_name + ";arbitrary unit").c_str(), 50, std::stod(argv[7 + 2 * variable_num]), std::stod(argv[8 + 2 * variable_num]), (argv[5 + 2 * variable_num] + std::string("/") + argv[6 + 2 * variable_num] + ".png").c_str(), true);
