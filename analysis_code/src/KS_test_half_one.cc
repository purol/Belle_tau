...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    std::string region_one = get_region_one((std::string(argv[5]) + "/M_deltaE_result.txt").c_str(), "deltaE", "M_inv_tau");
    ...
    loader_signal_train.Cut(region_one.c_str());
    ...
    loader_signal_test.Cut(region_one.c_str());
    ...
    loader_background_train.Cut(region_one.c_str());
    ...
    loader_background_test.Cut(region_one.c_str());
