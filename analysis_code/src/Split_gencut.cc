...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    loader_signal.LoadWithCut(argv[1], argv[2], "label", "nParticlesInList__botau__pl__clLFV_comb_1__bc > 0.5");
    loader_signal.PrintSeparateRootFile((std::string(argv[3]) + "/signal").c_str(), "signal_", "");
    loader_signal.end();

    Loader loader_bkg("gen_info");
    loader_bkg.LoadWithCut(argv[1], argv[2], "label", "nParticlesInList__botau__pl__clLFV_comb_1__bc < 0.5");
