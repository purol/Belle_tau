...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    loader.Cut(("(deltaE >= " + std::to_string(deltaE_peak - 5 * deltaE_left_sigma) + ") || ((deltaE < " + std::to_string(deltaE_peak - 5 * deltaE_left_sigma) + ") && (nParticlesInList__bopi__pl__clevtshape_kinematics__bc < 4.5))").c_str());
