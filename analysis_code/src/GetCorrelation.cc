...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    loader_one.DrawTH2D("BDT1", "M", ";BDT1 output;M [GeV/c^{2}]", 50, 0.0, 1.0, 50, M_peak - 20 * M_left_sigma, M_peak + 20 * M_right_sigma, (argv[6] + std::string("/") + "BDT1_M_distribution.png").c_str(), "COLZ");
    ...
    loader_two.DrawTH2D("BDT2", "M", ";BDT2 output;M [GeV/c^{2}]", 50, 0.0, 1.0, 50, M_peak - 20 * M_left_sigma, M_peak + 20 * M_right_sigma, (argv[6] + std::string("/") + "BDT2_M_distribution.png").c_str(), "COLZ");
    ...
    canvas_M_BDT1_diff->SaveAs((argv[6] + std::string("/") + "BDT1_M_diff_distribution.png").c_str());
    ...
    canvas_M_BDT2_diff->SaveAs((argv[6] + std::string("/") + "BDT2_M_diff_distribution.png").c_str());
