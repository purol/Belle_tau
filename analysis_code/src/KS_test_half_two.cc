...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    std::string region_two = get_region_two((std::string(argv[5]) + "/M_deltaE_result.txt").c_str(), "deltaE", "M_inv_tau");
    ...
    loader_signal_train.Cut(region_two.c_str());
    ...
    loader_signal_test.Cut(region_two.c_str());
    ...
    loader_background_train.Cut(region_two.c_str());
    ...
    loader_background_test.Cut(region_two.c_str());
