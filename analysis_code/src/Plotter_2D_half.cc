...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    else if (argc == 15) loader.DrawTH2D(variable_name_1.c_str(), variable_name_2.c_str(), (";" + variable_name_1 + ";" + variable_name_2 + ";Number of event").c_str(), 50, std::stod(argv[11]), std::stod(argv[12]), 50, std::stod(argv[13]), std::stod(argv[14]), (argv[5] + std::string("/") + argv[6] + ".png").c_str(), "BOX");
