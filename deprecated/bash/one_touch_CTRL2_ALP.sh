...
export FBDT_weight_DIR="/home/belle2/junewoo/storage_ghi/tau_Analysis/Sanae_ALP/v000" # FBDT weight file path
export FBDT_cut_DIR="/home/belle2/junewoo/storage_ghi/tau_Analysis/Sanae_ALP/v000" # FBDT cut file path
export resolution_file_path="/home/belle2/junewoo/storage_ghi/tau_Analysis/Sanae_ALP/v000" # resolution file path
# =================================================================================== #
...
bash ${shell_DIR}/submitter_Analysis_CTRL2.sh
wait_job "Analyze"
...
bash ${shell_DIR}/submitter_FBDT_comparison_CTRL2_ALP.sh
