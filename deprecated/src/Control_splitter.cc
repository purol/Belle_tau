...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    topipipinu.Cut("((111.5 < tauPlusMCMode) && (tauPlusMCMode < 112.5)) || ((111.5 < tauMinusMCMode) && (tauMinusMCMode < 112.5))");
    ...
    toKS0pinu.Cut("((225.5 < tauPlusMCMode) && (tauPlusMCMode < 226.5)) || ((225.5 < tauMinusMCMode) && (tauMinusMCMode < 226.5))");
    ...
    topurepipipinu.Cut("((225.5 > tauPlusMCMode) || (tauPlusMCMode > 226.5)) && ((225.5 > tauMinusMCMode) || (tauMinusMCMode > 226.5))");
    ...
    topureKS0pinu.Cut("((111.5 > tauPlusMCMode) || (tauPlusMCMode > 112.5)) && ((111.5 > tauMinusMCMode) || (tauMinusMCMode > 112.5))");
