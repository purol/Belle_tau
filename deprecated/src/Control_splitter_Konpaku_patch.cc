...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    topipipinu.Cut("nParticlesInList__botau__pl__clpipipi__bc > 0.5");
    ...
    toKS0pinu.Cut("nParticlesInList__botau__pl__cldirect__bc > 0.5");
    ...
    topurepipipinu.Cut("nParticlesInList__botau__pl__cldirect__bc < 0.5");
    ...
    topureKS0pinu.Cut("nParticlesInList__botau__pl__clpipipi__bc < 0.5");
