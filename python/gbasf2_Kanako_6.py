...
if tau_list:
    ...
    if(args.gencut): # make Ntuple for gencut
        tauCutsForGenStudy = "[1.60 < M < 1.94] and [-0.45 < deltaE < 0.39] and [roeEextra(cleanMask) < 5.0] and [extraInfo(OneMuon_muonID) > 0.1] and [extraInfo(TwoMuon_muonID) > 0.1] and [extraInfo(ThreeMuon_muonID) > 0.1]"
