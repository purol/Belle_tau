...
def AssignIndex(sample_name, event_name, sample_index, type_index):
    if(sample_name=="data"):
        sample_index = -1
...
sample_index = -1
type_index = -1
AssignIndex(sample_name=args.sample, event_name=args.type, sample_index=sample_index, type_index=type_index)
