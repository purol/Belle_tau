...
# usage: basf2 tau_mumumu_TauToMuMuMu.py --input_file input1.root [input2.root ...]
# last: 2026-09-10-00
...
if args.b2bii:
    if len(inputfiles) != 1:
        parser.error('--b2bii accepts exactly one --input_file')
    convertBelleMdstToBelleIIMdst(inputfiles[0], path=my_path)
else:
    ma.inputMdstList(environmentType='default', filelist=inputfiles, path=my_path)
