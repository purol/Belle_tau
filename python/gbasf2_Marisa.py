...
def MakeNtupleandHashmap(tau_list, photon_names, IsItNominal, Ntuple_name, hashmap_name, path):
    ...
    if(IsItNominal):
        ...
        my_path.for_each('RestOfEvent', 'RestOfEvents', roe_path_prompt)

        daughter_vars = ["extraInfo(" + var + ")" for var in variable_list_converted_one_muon + variable_list_converted_two_muon + variable_list_converted_three_muon]
    else:
        ...
        my_path.for_each('RestOfEvent', 'RestOfEvents', roe_path_ALP)
