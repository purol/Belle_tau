...
def MakeNtupleandHashmap(tau_list, photon_names, IsItNominal, path):
    ...
    if(IsItNominal):
        daughter_vars = ["daughter(0,muonID)", "daughter(1,muonID)", "daughter(2,muonID)"] + \
                        ...
                        ["daughter(0,minET2ETIsoScoreAsWeightedAvg(Const::chargedStableSet, 0, ECL, KLM))", "daughter(1,minET2ETIsoScoreAsWeightedAvg(Const::chargedStableSet, 0, ECL, KLM))", "daughter(2,minET2ETIsoScoreAsWeightedAvg(Const::chargedStableSet, 0, ECL, KLM))"] + \
        ...
        daughter_vars = ["daughter(0, daughter(0, muonID))", "daughter(0, daughter(1, muonID))", "daughter(1,muonID)"] + \
                        ...
                        ["daughter(0, daughter(0,minET2ETIsoScoreAsWeightedAvg(Const::chargedStableSet, 0, ECL, KLM)))", "daughter(0, daughter(1,minET2ETIsoScoreAsWeightedAvg(Const::chargedStableSet, 0, ECL, KLM)))", "daughter(1,minET2ETIsoScoreAsWeightedAvg(Const::chargedStableSet, 0, ECL, KLM))"] + \
...
# calculate isolation
my_path.add_module("TrackIsoCalculator", decayString="mu+:taulfv", particleListReference="Const::chargedStableSet", detectorNames=["ECL", "KLM"], useHighestProbMassForExt=False)
