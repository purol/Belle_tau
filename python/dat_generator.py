...
********************************************************************************
  901              4      Ihvp  ! =1,2,3,4
********************************************************************************
 2001          303e0      Jak1   =xpar(71)  First  Tau decay mask (tau-)
...
********************************************************************************
 2911          {mass:.3f}e0      AMALFA: mass of exotic axion-like particle [GeV]
 2912            0e0      ISALFA: spin of exotic axion-like particle
 2913          {a_coef:.1f}e0      VCALFA: coupling coefficient A in (A+B gamma5) term
 2914          {b_coef:.1f}e0      ACALFA: coupling coefficient B in (A+B gamma5) term
 ...
 2922          {lifetime:.3f}      CTALFA : c*tau (alpha lifetime) (mm)
********************************************************************************
EndX
"""
