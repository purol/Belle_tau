...
submit_Plotter ${code} ${Analysis_Name} ${VarName} 0.0 1.0 "before_leptonic_tag" "FBDT1_comp_tag" "plot" "${Signal_Type}"

code="${Belle_tau_DIR}/analysis_code/bin/var_comparison_tag"
VarName="BDT_output_2"
submit_Plotter ${code} ${Analysis_Name} ${VarName} 0.0 1.0 "before_leptonic_tag" "FBDT2_comp_tag" "plot" "${Signal_Type}"