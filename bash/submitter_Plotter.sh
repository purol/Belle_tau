...
code="${Belle_tau_DIR}/analysis_code/bin/Plotter"
VarName="deltaE"
submit_Plotter ${code} ${Analysis_Name} ${VarName} -0.5 0.4 "before_strict_M_deltaE_selection" "before_strict_M_deltaE_selection_deltaE" "plot" "${Signal_Type}" "${Background_Types_STR}"

code="${Belle_tau_DIR}/analysis_code/bin/Plotter"
VarName="M"
submit_Plotter ${code} ${Analysis_Name} ${VarName} 1.5 1.9 "before_strict_M_deltaE_selection" "before_strict_M_deltaE_selection_M" "plot" "${Signal_Type}" "${Background_Types_STR}"
