...
export nominal_analysis_DIR="/home/belle2/junewoo/storage_ghi/tau_Analysis/Sanae_ALP/v000" # nominal tau->mumumu analysis path
# =================================================================================== #
...
bash ${shell_DIR}/submitter_GetWeight_CTRL_ALP.sh
wait_job "GetWeight"
