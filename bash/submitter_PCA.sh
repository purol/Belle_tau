...
submit_code() {
  ...
  bsub -q s -J PCA -o "./${VerName}/${Analysis_VerName}/${toys_name}_cal.log" ${Code} --half_only --input_file "./${VerName}/${Analysis_VerName}/${toys_name}.csv" --output_file "./${VerName}/${Analysis_VerName}/${output_name}"
}
