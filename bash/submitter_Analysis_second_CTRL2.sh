...
submit_analysis() {
  ...
  if compgen -G "./${VerName}/${Analysis_VerName}/${SampleName}/before_strict_M_deltaE_selection/*.root" > /dev/null; then
    for file in "./${VerName}/${Analysis_VerName}/${SampleName}/before_strict_M_deltaE_selection"/*.root; do
      ...
      bsub -q s -J Analyze -o "./${VerName}/${Analysis_VerName}/${SampleName}/log_second/${filename}_${SampleName}_${VerName}_${Analysis_VerName}.log" -e "./${VerName}/${Analysis_VerName}/${SampleName}/err_second/${filename}_${SampleName}_${VerName}_${Analysis_VerName}.err" ${Code} "./${VerName}/${Analysis_VerName}/${SampleName}/before_strict_M_deltaE_selection" "${filename}.root" "./${VerName}/${Analysis_VerName}/${SampleName}" "${resolution_file_path}"
    done
  fi
...
submit_logger() {
  ...
  if compgen -G "./${VerName}/${Analysis_VerName}/${SampleName}/before_strict_M_deltaE_selection/*.root" > /dev/null; then
    bsub -q l -J Logger -o "./${VerName}/${Analysis_VerName}/${SampleName}/${SampleName}_${VerName}_${Analysis_VerName}_second.log" -e "./${VerName}/${Analysis_VerName}/${SampleName}/${SampleName}_${VerName}_${Analysis_VerName}_second.err" ${Code} "./${VerName}/${Analysis_VerName}/${SampleName}/before_strict_M_deltaE_selection" "${resolution_file_path}"
  fi
