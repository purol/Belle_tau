...
submit_Plotter ${code} ${Analysis_Name} ${VarName} 0.0 1.0 "before_leptonic_tag" "final_output_test_after_application" "FBDT1_comp_tag" "plot" "${Signal_Type}" "ALP"

code="${Belle_tau_DIR}/analysis_code/bin/var_comparison_tag"
VarName="BDT_output_2"
submit_Plotter ${code} ${Analysis_Name} ${VarName} 0.0 1.0 "before_leptonic_tag" "final_output_test_after_application" "FBDT2_comp_tag" "plot" "${Signal_Type}" "ALP"