...
submit_code() {
  ...
  get_params "./${VerName}/${Analysis_VerName}/ALP/final_output" | while read mass life A B; do
    ...
    "KS_${VarName}_${mass}_${life}_${A}_${B}.png" \
    "${ALP_Type}" \
...
code="${Belle_tau_DIR}/analysis_code/bin/KS_test_split_one_ALP"
...
code="${Belle_tau_DIR}/analysis_code/bin/KS_test_split_two_ALP"
