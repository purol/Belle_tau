...
submit_code() {
  ...
  get_params "./${VerName}/${Analysis_VerName}/ALP/final_output" | while read mass life A B; do
    ...
    bsub -q s \
    -J PCA \
    -o "./${VerName}/${Analysis_VerName}/${toys_name}_cal_${mass}_${life}_${A}_${B}.log" \
    ${Code} \
    --half_only \
    --input_file "./${VerName}/${Analysis_VerName}/${toys_name}_${mass}_${life}_${A}_${B}.csv" \
    --output_file "./${VerName}/${Analysis_VerName}/${output_name}_${mass}_${life}_${A}_${B}"
